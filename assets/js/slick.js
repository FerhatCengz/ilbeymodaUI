...
(function (factory) {
  ...
  Slick = (function () {
    ...
    function Slick(element, settings) {
      ...
      _.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<button class="slick-prev" aria-label="İleri" type="button">İleri</button>',
        nextArrow:
          '<button class="slick-next" aria-label="Geri" type="button">Geri</button>',
        autoplay: false,
        autoplaySpeed: 3000,
        centerMode: false,
        centerPadding: "50px",
  ...
  Slick.prototype.getLeft = function (slideIndex) {
    ...
    _.slideOffset = -(
      slideIndex *
      (_.options.slidesMargin / _.options.slidesToShow)
    );
    ...
    if (_.options.infinite === true) {
      if (_.slideCount > _.options.slidesToShow) {
        _.slideOffset =
          (_.slideWidth * _.options.slidesToShow +
            _.options.slidesMargin +
            slideIndex *
              Math.floor(_.options.slidesMargin / _.options.slidesToShow)) *
          -1;
        coef = -1;
      ...
      if (_.slideCount % _.options.slidesToScroll !== 0) {
        if (
          ...
          if (slideIndex > _.slideCount) {
            ...
            _.slideOffset =
              ((_.slideCount % _.options.slidesToScroll) * _.slideWidth +
                _.slideWidth / 2 +
                _.options.slidesMargin / 2) *
              -1;
            verticalOffset =
  ...
  Slick.prototype.setDimensions = function () {
    var _ = this,
      _widthMargin = 0,
      _widthTrack =
        _.options.slidesMargin * _.$slideTrack.children(".slick-slide").length;
    ...
    if (_.options.vertical === false && _.options.variableWidth === false) {
      ...
      _.$slideTrack.width(
        Math.abs(_.slideWidth * _.$slideTrack.children(".slick-slide").length) +
          _widthTrack
      );
    ...
    if (_.options.variableWidth === false)
      _.$slideTrack
        .children(".slick-slide")
        .width(_.slideWidth - offset + _widthMargin);
  };
  ...
  Slick.prototype.setSlideClasses = function (index) {
    ...
    MarginRtl = "right";
    if (_.options.rtl == true) MarginRtl = "left";
    if (_.options.vertical == false) {
      ...
      _.$slider.children(".slick-list").css({
